...
| `fe_facade_url` | `https://web-host.wippy.ai/webcomponents-1.0.4` | CDN base URL for frontend bundle |
...
```json
{
  "facade_url": "https://web-host.wippy.ai/webcomponents-1.0.4",
  "iframe_origin": "https://web-host.wippy.ai",
  "iframe_url": "https://web-host.wippy.ai/webcomponents-1.0.4/iframe.html?waitForCustomConfig",
