...
| Requirement | Default | Description |
|---|---|---|
| `fe_facade_url` | `https://web-host.wippy.ai/webcomponents-1.0.50` | CDN base URL for the Web Host frontend bundle |
...
```json
{
  "facade_url": "https://web-host.wippy.ai/webcomponents-1.0.50",
  "iframe_origin": "https://web-host.wippy.ai",
  "iframe_url": "https://web-host.wippy.ai/webcomponents-1.0.50/iframe.html?waitForCustomConfig",
