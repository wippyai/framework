...
| Requirement | Default | Description |
|---|---|---|
| `fe_facade_url` | `https://web-host.wippy.ai/webcomponents-1.0.14` | CDN base URL for the Web Host frontend bundle |
...
```json
{
  "facade_url": "https://web-host.wippy.ai/webcomponents-1.0.14",
  "iframe_origin": "https://web-host.wippy.ai",
  "iframe_url": "https://web-host.wippy.ai/webcomponents-1.0.14/iframe.html?waitForCustomConfig",
