import { g as Zt } from "./chunk-55IACEB6-DuOOmvV2.js";
import { s as te } from "./chunk-EDXVE4YY-j9tcUx_w.js";
import { _ as f, l as _, c as w, r as ee, u as se, a as ie, b as re, g as ae, s as ne, p as oe, q as le, T as ce, k as U, z as he } from "./mermaid.core-Jw3znkh4.js";
var Dt = (function() {
  var t = /* @__PURE__ */ f(function(B, a, c, r) {
    for (c = c || {}, r = B.length; r--; c[B[r]] = a) ;
    return c;
  }, "o"), e = [1, 2], o = [1, 3], s = [1, 4], u = [2, 4], d = [1, 9], S = [1, 11], g = [1, 16], n = [1, 17], T = [1, 18], m = [1, 19], O = [1, 33], A = [1, 20], k = [1, 21], h = [1, 22], x = [1, 23], D = [1, 24], $ = [1, 26], L = [1, 27], P = [1, 28], I = [1, 29], X = [1, 30], st = [1, 31], it = [1, 32], rt = [1, 35], at = [1, 36], nt = [1, 37], ot = [1, 38], W = [1, 34], p = [1, 4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 41, 45, 48, 51, 52, 53, 54, 57], lt = [1, 4, 5, 14, 15, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 39, 40, 41, 45, 48, 51, 52, 53, 54, 57], At = [4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 41, 45, 48, 51, 52, 53, 54, 57], yt = {
    ...
    performAction: /* @__PURE__ */ f(function(a, c, r, y, E, i, J) {
      var l = i.length - 1;
      switch (E) {
        case 3:
        ...
        case 19:
          ...
          break;
        case 20:
          var Y = i[l], j = i[l - 2].trim();
          if (i[l].match(":")) {
            var ht = i[l].split(":");
            Y = ht[0], j = [j, ht[1]];
          }
          this.$ = { stmt: "state", id: Y, type: "default", description: j };
          break;
        case 21:
    ...
    parse: /* @__PURE__ */ f(function(a) {
      var c = this, r = [0], y = [], E = [null], i = [], J = this.table, l = "", Y = 0, j = 0, ht = 2, q = 1, gt = i.slice.call(arguments, 1), b = Object.create(this.lexer), V = { yy: {} };
      for (var Tt in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, Tt) && (V.yy[Tt] = this.yy[Tt]);
      b.setInput(a, V.yy), V.yy.lexer = b, V.yy.parser = this, typeof b.yylloc > "u" && (b.yylloc = {});
      var Et = b.yylloc;
      i.push(Et);
      ...
      function Qt(N) {
        r.length = r.length - 2 * N, E.length = E.length - N, i.length = i.length - N;
      }
      f(Qt, "popStack");
      function xt() {
        var N;
        return N = y.pop() || b.lex() || q, typeof N != "number" && (N instanceof Array && (y = N, N = y.pop()), N = c.symbols_[N] || N), N;
      }
      f(xt, "lex");
      for (var C, M, R, _t, H = {}, ut, F, Lt, dt; ; ) {
        if (M = r[r.length - 1], this.defaultActions[M] ? R = this.defaultActions[M] : ((C === null || typeof C > "u") && (C = xt()), R = J[M] && J[M][C]), typeof R > "u" || !R.length || !R[0]) {
          var mt = "";
          dt = [];
          for (ut in J[M])
...
` + b.showPosition() + `
Expecting ` + dt.join(", ") + ", got '" + (this.terminals_[C] || C) + "'" : mt = "Parse error on line " + (Y + 1) + ": Unexpected " + (C == q ? "end of input" : "'" + (this.terminals_[C] || C) + "'"), this.parseError(mt, {
            text: b.match,
        ...
        if (R[0] instanceof Array && R.length > 1)
          throw new Error("Parse Error: multiple actions possible at state: " + M + ", token: " + C);
        switch (R[0]) {
          case 1:
            r.push(C), E.push(b.yytext), i.push(b.yylloc), r.push(R[1]), C = null, j = b.yyleng, l = b.yytext, Y = b.yylineno, Et = b.yylloc;
            break;
          case 2:
            if (F = this.productions_[R[1]][1], H.$ = E[E.length - F], H._$ = {
              ...
              return _t;
            F && (r = r.slice(0, -1 * F * 2), E = E.slice(0, -1 * F), i = i.slice(0, -1 * F)), r.push(this.productions_[R[1]][0]), E.push(H.$), i.push(H._$), Lt = J[r[r.length - 2]][r[r.length - 1]], r.push(Lt);
            break;
          case 3:
            return !0;
        }
...
var Ge = Dt, ue = "TB", Ft = "TB", It = "dir", K = "state", z = "root", vt = "relation", de = "classDef", fe = "style", pe = "applyClass", tt = "default", Bt = "divider", Gt = "fill:none", Yt = "fill: #333", Vt = "c", Mt = "markdown", Ut = "normal", bt = "rect", kt = "rectWithTitle", Se = "stateStart", ye = "stateEnd", Nt = "divider", Ot = "roundedWithTitle", ge = "note", Te = "noteGroup", et = "statediagram", Ee = "state", _e = `${et}-${Ee}`, Wt = "transition", me = "note", be = "note-edge", ke = `${Wt} ${be}`, De = `${et}-${me}`, ve = "cluster", Ce = `${et}-${ve}`, Ae = "cluster-alt", xe = `${et}-${Ae}`, jt = "parent", Ht = "note", Le = "state", Ct = "----", Ie = `${Ct}${Ht}`, Rt = `${Ct}${jt}`, zt = /* @__PURE__ */ f((t, e = Ft) => {
  ...
  return o;
}, "getDir"), Ne = /* @__PURE__ */ f(function(t, e) {
  return e.db.getClasses();
}, "getClasses"), Oe = /* @__PURE__ */ f(async function(t, e, o, s) {
  ...
  try {
    ...
    _.error("❌ Error injecting clickable links:", O);
  }
  se.insertTitle(
    n,
...
function St(t = "", e = 0, o = "", s = Ct) {
  const u = o !== null && o.length > 0 ? `${s}${o}` : "";
  return `${Le}-${t}${u}-${e}`;
}
f(St, "stateDomId");
var Re = /* @__PURE__ */ f((t, e, o, s, u, d, S, g) => {
...
var Z = /* @__PURE__ */ f((t, e, o, s, u, d, S, g) => {
  const n = e.id, T = o.get(n), m = Kt(T), O = Xt(T), A = w();
  if (_.info("dataFetcher parsedItem", e, T, O), n !== "root") {
    let k = bt;
    ...
    if (x.shape === Nt && (x.label = ""), t && t.id !== "root" && (_.trace("Setting node ", n, " to be child of its parent ", t.id), x.parentId = t.id), x.centerLabel = !0, e.note) {
      const D = {
        labelStyle: "",
        shape: ge,
        label: e.note.text,
      ...
      G++, L.id = $, D.parentId = $, Q(s, L, g), Q(s, D, g), Q(s, x, g);
      let P = n, I = D.id;
  ...
  e.doc && (_.trace("Adding nodes children "), Re(e, e.doc, o, s, u, !d, S, g));
  ...
  handleStyleDef(t) {
    ...
    for (const s of e) {
      ...
      u && (u.styles = o.map((d) => d.replace(/;/g, "")?.trim()));
    }
  }
  setRootDoc(t) {
   ...
   */
  addState(t, e = tt, o = void 0, s = void 0, u = void 0, d = void 0, S = void 0, g = void 0) {
    const n = t?.trim();
