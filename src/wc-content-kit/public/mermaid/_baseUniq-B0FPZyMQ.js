import { aX as L, bl as ln, aH as A, aV as P, aG as W, bm as gn, bn as dn, bo as hn, bp as z, bq as pn, br as An, bs as m, aY as N, b1 as U, b4 as T, bt as _n, a$ as on, bu as wn, bv as On, aI as V, bw as vn, bx as R } from "./mermaid.core-Jw3znkh4.js";
...
var B = P ? P.prototype : void 0, H = B ? B.toString : void 0;
function k(n) {
  if (typeof n == "string")
    return n;
  if (A(n))
...
function fn(n, r, e, i, f, t) {
  ...
  if (h && g)
    return h == r && g == n;
  var l = -1, d = !0, o = e & zn ? new b() : void 0;
...
var Nr = 1 / 0, Ur = R && 1 / C(new R([, -0]))[1] == Nr ? function(n) {
  return new R(n);
} : yn, Br = 200;
function Xr(n, r, e) {
