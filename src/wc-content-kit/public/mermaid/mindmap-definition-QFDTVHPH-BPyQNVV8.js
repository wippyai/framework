import { g as ce } from "./chunk-55IACEB6-DuOOmvV2.js";
import { s as le } from "./chunk-EDXVE4YY-j9tcUx_w.js";
import { _ as l, l as I, o as he, r as de, D as ge, G, c as U, i as F, aF as ue, V as pe, W as fe, X as me } from "./mermaid.core-Jw3znkh4.js";
const E = [];
for (let e = 0; e < 256; ++e)
...
function ke(e, n, g) {
  ...
  e = e || {};
  const a = e.random ?? e.rng?.() ?? _e();
  if (a.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return a[6] = a[6] & 15 | 64, a[8] = a[8] & 63 | 128, ye(a);
}
var q = (function() {
  var e = /* @__PURE__ */ l(function(N, s, i, o) {
    for (i = i || {}, o = N.length; o--; i[N[o]] = s) ;
    return i;
  }, "o"), n = [1, 4], g = [1, 13], a = [1, 12], t = [1, 15], h = [1, 16], f = [1, 20], m = [1, 19], _ = [6, 7, 8], T = [1, 26], C = [1, 24], w = [1, 25], d = [6, 7, 11], R = [1, 6, 13, 15, 16, 19, 22], J = [1, 33], K = [1, 34], A = [1, 6, 7, 11, 13, 15, 16, 19, 22], j = {
    ...
    parse: /* @__PURE__ */ l(function(s) {
      var i = this, o = [0], c = [], p = [null], r = [], $ = this.table, u = "", P = 0, Q = 0, se = 2, Z = 1, re = r.slice.call(arguments, 1), y = Object.create(this.lexer), L = { yy: {} };
      ...
      function ee() {
        var k;
        return k = c.pop() || y.lex() || Z, typeof k != "number" && (k instanceof Array && (c = k, k = c.pop()), k = i.symbols_[k] || k), k;
      }
      l(ee, "lex");
      for (var b, v, S, X, O = {}, M, x, te, V; ; ) {
        if (v = o[o.length - 1], this.defaultActions[v] ? S = this.defaultActions[v] : ((b === null || typeof b > "u") && (b = ee()), S = $[v] && $[v][b]), typeof S > "u" || !S.length || !S[0]) {
          var z = "";
          V = [];
          for (M in $[v])
            this.terminals_[M] && M > se && V.push("'" + this.terminals_[M] + "'");
          y.showPosition ? z = "Parse error on line " + (P + 1) + `:
` + y.showPosition() + `
Expecting ` + V.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : z = "Parse error on line " + (P + 1) + ": Unexpected " + (b == Z ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(z, {
            text: y.match,
        ...
        switch (S[0]) {
          case 1:
            o.push(b), p.push(y.yytext), r.push(y.yylloc), o.push(S[1]), b = null, Q = y.yyleng, u = y.yytext, P = y.yylineno, W = y.yylloc;
            break;
          case 2:
            if (x = this.productions_[S[1]][1], O.$ = p[p.length - x], O._$ = {
              ...
              p,
              r
            ].concat(re)), typeof X < "u")
              return X;
            x && (o = o.slice(0, -1 * x * 2), p = p.slice(0, -1 * x), r = r.slice(0, -1 * x)), o.push(this.productions_[S[1]][0]), p.push(O.$), r.push(O._$), te = $[o[o.length - 2]][o[o.length - 1]], o.push(te);
            break;
          case 3:
            return !0;
        }
...
` + this.showPosition(), {
  ...
  return l(B, "Parser"), B.prototype = j, j.Parser = B, new B();
})();
q.parser = q;
var Se = q, xe = 12, D = {
  DEFAULT: 0,
  ...
  decorateNode(e) {
    if (!e)
      return;
    const n = U(), g = this.nodes[this.nodes.length - 1];
   ...
   */
  getData() {
    const e = this.getMindmap(), n = U(), a = ue().layout !== void 0, t = n;
    ...
    const h = [], f = [];
    this.flattenNodes(e, h), this.generateEdges(e, f), I.debug(
...
}, Ne = /* @__PURE__ */ l(async (e, n, g, a) => {
  I.debug(`Rendering mindmap diagram
` + e);
  const t = a.db, h = t.getData(), f = ce(n, h.config.securityLevel);
  if (h.type = a.type, h.layoutAlgorithm = he(h.config.layout, {
  ...
  const { themeVariables: _ } = ge(), { useGradient: T, gradientStart: C, gradientStop: w } = _;
  if (T && C && w) {
    ...
    R.append("stop").attr("offset", "0%").attr("stop-color", C).attr("stop-opacity", 1), R.append("stop").attr("offset", "100%").attr("stop-color", w).attr("stop-opacity", 1);
  }
  le(
    f,
  ...
  for (let t = 0; t < e.THEME_COLOR_LIMIT; t++)
    e["lineColor" + t] = e["lineColor" + t] || e["cScaleInv" + t], pe(e["lineColor" + t]) ? e["lineColor" + t] = fe(e["lineColor" + t], 20) : e["lineColor" + t] = me(e["lineColor" + t], 20);
  for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) {
  ...
  return a;
}, "genSections"), Te = /* @__PURE__ */ l((e, n, g) => {
  let a = "";
  for (let t = 0; t < e; t++)
    a += `
    [data-look="neo"].mindmap-node.section-${t - 1} rect, [data-look="neo"].mindmap-node.section-${t - 1} path, [data-look="neo"].mindmap-node.section-${t - 1} circle, [data-look="neo"].mindmap-node.section-${t - 1} polygon {
  ...
  ${e.useGradient && g && e.mainBkg ? Te(e.THEME_COLOR_LIMIT, g, e.mainBkg) : ""}
`;
}, "getStyles"), Ie = Oe, Ae = {
  get db() {
    return new De();
