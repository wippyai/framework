import { _ as g, n as tr, c as $, d as Mt, l as at, j as Ce, e as er, f as rr, k as P, b as ke, s as ar, p as sr, a as ir, g as nr, q as or, t as cr, J as lr, z as hr, i as Bt, u as J, L as Z, M as wt, N as Me, Z as dr, D as Yt, O as Tr, P as Be } from "./mermaid.core-Jw3znkh4.js";
import { a as pr, b as ee, g as dt, d as Er, e as re, f as ae } from "./chunk-YZCP3GAM-fs19uw3J.js";
import { I as ur } from "./chunk-QZHKN3VN-DnDrFfng.js";
var $t = (function() {
  var e = /* @__PURE__ */ g(function(ut, w, v, k) {
    for (v = v || {}, k = ut.length; k--; v[ut[k]] = w) ;
    return v;
  }, "o"), t = [1, 2], a = [1, 3], r = [1, 4], i = [2, 4], n = [1, 9], s = [1, 11], o = [1, 12], E = [1, 14], T = [1, 15], l = [1, 17], x = [1, 18], u = [1, 19], O = [1, 25], p = [1, 26], f = [1, 27], _ = [1, 28], I = [1, 29], L = [1, 30], b = [1, 31], S = [1, 32], A = [1, 33], N = [1, 34], B = [1, 35], V = [1, 36], H = [1, 37], U = [1, 38], G = [1, 39], Q = [1, 40], j = [1, 42], q = [1, 43], st = [1, 44], tt = [1, 45], it = [1, 46], Y = [1, 47], C = [1, 4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 48, 49, 50, 51, 53, 54, 56, 61, 62, 63, 64, 73], Nt = [1, 74], m = [1, 80], D = [1, 81], lt = [1, 82], et = [1, 83], W = [1, 84], se = [1, 85], ie = [1, 86], ne = [1, 87], oe = [1, 88], ce = [1, 89], le = [1, 90], he = [1, 91], de = [1, 92], Te = [1, 93], pe = [1, 94], Ee = [1, 95], ue = [1, 96], fe = [1, 97], _e = [1, 98], ge = [1, 99], xe = [1, 100], Ie = [1, 101], ye = [1, 102], Re = [1, 103], Oe = [1, 104], Le = [1, 105], be = [2, 78], mt = [4, 5, 17, 51, 53, 54], Pt = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 51, 53, 54, 56, 61, 62, 63, 64, 73], me = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 50, 51, 53, 54, 56, 61, 62, 63, 64, 73], qt = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 49, 51, 53, 54, 56, 61, 62, 63, 64, 73], Ae = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 48, 51, 53, 54, 56, 61, 62, 63, 64, 73], zt = [5, 52], K = [70, 71, 72, 73], ot = [1, 151], Ut = {
    ...
    parse: /* @__PURE__ */ g(function(w) {
      var v = this, k = [0], y = [], z = [null], c = [], At = this.table, d = "", Dt = 0, Se = 0, Ze = 2, we = 1, Qe = c.slice.call(arguments, 1), X = Object.create(this.lexer), gt = { yy: {} };
      ...
      var Xt = X.yylloc;
      c.push(Xt);
      var $e = X.options && X.options.ranges;
      ...
      function Ne() {
        var nt;
        return nt = y.pop() || X.lex() || we, typeof nt != "number" && (nt instanceof Array && (y = nt, nt = y.pop()), nt = v.symbols_[nt] || nt), nt;
      }
      g(Ne, "lex");
      for (var rt, xt, ct, Jt, Ot = {}, vt, Tt, Pe, Ct; ; ) {
        if (xt = k[k.length - 1], this.defaultActions[xt] ? ct = this.defaultActions[xt] : ((rt === null || typeof rt > "u") && (rt = Ne()), ct = At[xt] && At[xt][rt]), typeof ct > "u" || !ct.length || !ct[0]) {
          ...
          X.showPosition ? Zt = "Parse error on line " + (Dt + 1) + `:
` + X.showPosition() + `
Expecting ` + Ct.join(", ") + ", got '" + (this.terminals_[rt] || rt) + "'" : Zt = "Parse error on line " + (Dt + 1) + ": Unexpected " + (rt == we ? "end of input" : "'" + (this.terminals_[rt] || rt) + "'"), this.parseError(Zt, {
        ...
        switch (ct[0]) {
          case 1:
            k.push(rt), z.push(X.yytext), c.push(X.yylloc), k.push(ct[1]), rt = null, Se = X.yyleng, d = X.yytext, Dt = X.yylineno, Xt = X.yylloc;
            break;
          case 2:
...
`;
  ...
  var l = "";
  o.class !== void 0 && (l = " " + o.class);
  let x = o.width > a ? o.width : a;
  const u = T.append("rect");
  if (u.attr("class", "actorPopupMenuPanel" + l), u.attr("x", o.x), u.attr("y", o.height), u.attr("fill", o.fill), u.attr("stroke", o.stroke), u.attr("width", x), u.attr("height", o.height), u.attr("rx", o.rx), u.attr("ry", o.ry), n != null) {
    var O = 20;
    for (let _ in n) {
      var p = T.append("a"), f = Ce.sanitizeUrl(n[_]);
  ...
  return u.attr("height", O), { height: o.height + O, width: x };
  ...
  if (r.attr("height", Math.round(s.height)).attr("width", Math.round(s.width)), t.class === "noteText") {
    ...
    let { startx: o, stopx: E, starty: T } = a;
    if (o > E) {
      const l = o;
      o = E, E = l;
    }
    r.attr("x", Math.round(o + Math.abs(o - E) / 2 - s.width / 2)), t.class === "loopText" ? r.attr("y", Math.round(T)) : r.attr("y", Math.round(T - s.height));
  }
  return [r];
}, "drawKatex"), bt = /* @__PURE__ */ g(function(e, t) {
  let a = 0, r = 0;
  const i = t.text.split(P.lineBreakRegex), [n, s] = Me(t.fontSize);
  let o = [], E = 0, T = /* @__PURE__ */ g(() => t.y, "yfunc");
  ...
  const n = r ? t.stopy : t.starty, s = t.x + t.width / 2, o = n + t.height, { look: E, theme: T, themeVariables: l } = a, { bkgColorArray: x, borderColorArray: u } = l, O = e.append("g").lower();
  var p = O;
  r || (M++, Object.keys(t.links || {}).length && !a.forceMenus && p.attr("onclick", Ft(`actor${M}_popup`)).attr("cursor", "pointer"), p.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", o).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), p = O.append("g"), t.actorCnt = M, t.links != null && p.attr("id", "root-" + M), E === "neo" && p.attr("data-look", "neo"));
  const f = dt();
  var _ = "actor";
...
}, "drawActorTypeQueue"), Ar = /* @__PURE__ */ g(function(e, t, a, r, i, n) {
  const s = r ? t.stopy : t.starty, o = t.x + t.width / 2, E = s + 75, { look: T, theme: l, themeVariables: x } = a, { bkgColorArray: u, borderColorArray: O, actorBorder: p, actorBkg: f } = x, _ = e.append("g").lower();
  r || (M++, _.append("line").attr("id", "actor" + M).attr("x1", o).attr("y1", E).attr("x2", o).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = M);
  const I = e.append("g");
  let L = yt;
  ...
  const n = r ? t.stopy : t.starty, s = t.x + t.width / 2, o = n + 75, { look: E, theme: T, themeVariables: l } = a, { bkgColorArray: x, borderColorArray: u } = l, O = e.append("g").lower(), p = e.append("g");
  let f = "actor";
  ...
  return t.height = A.height + (a?.sequence?.labelBoxHeight ?? 0), r || (M++, O.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", o).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = M), Et(a, Z(t.description))(
    t.description,
    p,
    _.x,
    _.y + (r ? 15 : 30),
  ...
  const n = r ? t.stopy : t.starty, s = t.x + t.width / 2, o = n + t.height + 2 * a.boxTextMargin, { theme: E, themeVariables: T, look: l } = a, { bkgColorArray: x, borderColorArray: u, actorBorder: O } = T, p = e.append("g").lower();
  let f = p;
  r || (M++, Object.keys(t.links || {}).length && !a.forceMenus && f.attr("onclick", Ft(`actor${M}_popup`)).attr("cursor", "pointer"), f.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", o).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), f = p.append("g"), t.actorCnt = M, t.links != null && f.attr("id", "root-" + M), l === "neo" && f.attr("data-look", "neo"));
  const _ = dt();
  let I = "actor";
...
`;
  ...
  const n = r ? t.stopy : t.starty, s = t.x + t.width / 2, o = n + 80, E = 22, T = e.append("g").lower(), { look: l, theme: x, themeVariables: u } = a, { bkgColorArray: O, borderColorArray: p, actorBorder: f } = u;
  r || (M++, T.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", o).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = M);
  const _ = e.append("g");
  let I = yt;
  ...
  const n = r ? t.stopy : t.starty, s = t.x + t.width / 2, o = n + 80, { look: E, theme: T, themeVariables: l } = a, { bkgColorArray: x, borderColorArray: u, actorBorder: O } = l, p = e.append("g").lower();
  r || (M++, p.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", o).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = M);
  const f = e.append("g");
  let _ = yt;
  ...
  const N = i.get(t.name) ?? 0;
  return pt.has(T) ? (f.style("stroke", u[N % u.length]), f.style("fill", x[N % u.length])) : f.style("stroke", O), Et(a, Z(t.description))(
    t.description,
    f,
    A.x,
    L + 35 * I - (E === "neo" ? 10 : 0),
...
}, "drawActorTypeActor"), kr = /* @__PURE__ */ g(async function(e, t, a, r, i, n, s) {
  const o = s ?? new Map(
    [...n.db.getActors().values()].map((E, T) => [E.name, T])
  );
  switch (t.type) {
    case "actor":
  ...
  return e.append("g");
}, "anchorElement"), Cr = /* @__PURE__ */ g(function(e, t, a, r, i, n, s) {
  const { theme: o, themeVariables: E } = r, { bkgColorArray: T, borderColorArray: l, mainBkg: x } = E, u = dt(), O = t.anchored, p = t.actor;
  ...
  pt.has(o) && (f.style("stroke", l[I % l.length]), f.style("fill", T[I % l.length] ?? x));
  ...
  let p = ee();
  p.text = a, p.x = t.startx, p.y = t.starty, p.fontFamily = T, p.fontSize = l, p.fontWeight = x, p.anchor = "middle", p.valign = "middle", p.tspan = !1, p.width = Math.max(E ?? 0, 50), p.height = o + (r.look === "neo" ? 15 : 0) || 20, p.textMargin = s, p.class = "labelText", Ve(u, p), p = Ke(), p.text = t.title, p.x = t.startx + E / 2 + (t.stopx - t.startx) / 2, p.y = t.starty + n + s, p.anchor = "middle", p.valign = "middle", p.textMargin = s, p.class = "loopText", p.fontFamily = T, p.fontSize = l, p.fontWeight = x, p.wrap = !0;
  let f = Z(p.text) ? await Wt(u, p, t) : bt(u, p);
  if (t.sectionTitles !== void 0) {
    for (const [_, I] of Object.entries(t.sectionTitles))
      if (I.message) {
        p.text = I.message, p.x = t.startx + (t.stopx - t.startx) / 2, p.y = t.sections[_].y + n + s, p.class = "loopText", p.anchor = "middle", p.valign = "middle", p.tspan = !1, p.fontFamily = T, p.fontSize = l, p.fontWeight = x, p.wrap = t.wrap, Z(p.text) ? (t.starty = t.sections[_].y, await Wt(u, p, t)) : bt(u, p);
        let L = Math.round(
  ...
  function e(n, s, o, E, T, l, x) {
    const u = s.append("text").attr("x", o + T / 2).attr("y", E + l / 2 + 5).style("text-anchor", "middle").text(n);
    i(u, x);
  }
  g(e, "byText");
  function t(n, s, o, E, T, l, x, u) {
    const { actorFontSize: O, actorFontFamily: p, actorFontWeight: f } = u, [_, I] = Me(O), L = n.split(P.lineBreakRegex);
    for (let b = 0; b < L.length; b++) {
      const S = b * _ - _ * (L.length - 1) / 2, A = s.append("text").attr("x", o + T / 2).attr("y", E).style("text-anchor", "middle").style("font-size", I).style("font-weight", f).style("font-family", p);
      A.append("tspan").attr("x", o + T / 2).attr("dy", S).text(L[b]), A.attr("y", E + l / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), i(A, x);
    }
  }
  g(t, "byTspan");
  function a(n, s, o, E, T, l, x, u) {
    const O = s.append("switch"), f = O.append("foreignObject").attr("x", o).attr("y", E).attr("width", T).attr("height", l).append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    f.append("div").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(n), t(n, O, o, E, T, l, x, u), i(f, x);
  }
  g(a, "byFo");
  async function r(n, s, o, E, T, l, x, u) {
    const O = await wt(n, Yt()), p = s.append("switch"), _ = p.append("foreignObject").attr("x", o + T / 2 - O.width / 2).attr("y", E + l / 2 - O.height / 2).attr("width", O.width).attr("height", O.height).append("xhtml:div").style("height", "100%").style("width", "100%");
    _.append("div").style("text-align", "center").style("vertical-align", "middle").html(await Be(n, Yt())), t(n, p, o, E, T, l, x, u), i(_, x);
  }
  g(r, "byKatex");
  function i(n, s) {
    for (const o in s)
  ...
  function e(i, n, s, o, E, T, l) {
    const x = n.append("text").attr("x", s).attr("y", o).style("text-anchor", "start").text(i);
    r(x, l);
  }
  g(e, "byText");
  function t(i, n, s, o, E, T, l, x) {
    const { actorFontSize: u, actorFontFamily: O, actorFontWeight: p } = x, f = i.split(P.lineBreakRegex);
    for (let _ = 0; _ < f.length; _++) {
      const I = _ * u - u * (f.length - 1) / 2, L = n.append("text").attr("x", s).attr("y", o).style("text-anchor", "start").style("font-size", u).style("font-weight", p).style("font-family", O);
      L.append("tspan").attr("x", s).attr("dy", I).text(f[_]), L.attr("y", o + T / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), r(L, l);
    }
  }
  g(t, "byTspan");
  function a(i, n, s, o, E, T, l, x) {
    const u = n.append("switch"), p = u.append("foreignObject").attr("x", s).attr("y", o).attr("width", E).attr("height", T).append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    p.append("div").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), t(i, u, s, o, E, T, l, x), r(p, l);
  }
  g(a, "byFo");
  function r(i, n) {
    for (const s in n)
  ...
  updateBounds: /* @__PURE__ */ g(function(e, t, a, r) {
    ...
    function s(o) {
      return /* @__PURE__ */ g(function(T) {
        ...
        i.updateVal(T, "starty", t - l * h.boxMargin, Math.min), i.updateVal(T, "stopy", r + l * h.boxMargin, Math.max), i.updateVal(R.data, "startx", e - l * h.boxMargin, Math.min), i.updateVal(R.data, "stopx", a + l * h.boxMargin, Math.max), o !== "activation" && (i.updateVal(T, "startx", e - l * h.boxMargin, Math.min), i.updateVal(T, "stopx", a + l * h.boxMargin, Math.max), i.updateVal(R.data, "starty", t - l * h.boxMargin, Math.min), i.updateVal(R.data, "stopy", r + l * h.boxMargin, Math.max));
      }, "updateItemBounds");
    }
    g(s, "updateFn"), this.sequenceItems.forEach(s()), this.activations.forEach(s("activation"));
  }, "updateBounds"),
  insert: /* @__PURE__ */ g(function(e, t, a, r) {
    const i = P.getMin(e, a), n = P.getMax(e, a), s = P.getMin(t, r), o = P.getMax(t, r);
  ...
  const o = Z(s.text) ? await Wt(i, s) : bt(i, s), E = Math.round(
    o.map((T) => (T._groups || T)[0][0].getBBox().height).reduce((T, l) => T + l)
  );
...
}, "drawNote"), De = /* @__PURE__ */ g(function(e, t, a, r, i, n, s) {
  const o = r.db.getActors(), E = o.get(t.from), T = o.get(t.to), l = a.sequenceVisible;
...
async function Fe(e, t) {
  ...
  const { startx: a, stopx: r, message: i } = t, n = P.splitBreaks(i).length, s = Z(i), o = s ? await wt(i, $()) : J.calculateTextDimensions(i, Rt(h));
  if (!s) {
    const x = o.height / n;
...
g(Fe, "boundMessage");
var $r = /* @__PURE__ */ g(async function(e, t, a, r, i, n) {
  const { startx: s, stopx: o, starty: E, message: T, type: l, sequenceIndex: x, sequenceVisible: u } = t, O = J.calculateTextDimensions(T, Rt(h)), p = ee();
  p.x = s, p.y = E + 10, p.width = o - s, p.class = "messageText", p.dy = "1em", p.text = T, p.fontFamily = h.messageFontFamily, p.fontSize = h.messageFontSize, p.fontWeight = h.messageFontWeight, p.anchor = h.messageAlign, p.valign = "center", p.textMargin = h.wrapPadding, p.tspan = !1, Z(p.text) ? await Wt(e, p, { startx: s, stopx: o, starty: a }) : bt(e, p);
  const f = O.width;
  let _;
  if (s === o) {
    ...
    ), Qt(i, r) && De(e, i, t, r, s, o, a);
  } else
    _ = e.append("line"), _.attr("x1", s), _.attr("y1", a), _.attr("x2", o), _.attr("y2", a), Qt(i, r) && De(e, i, t, r, s, o, a);
...
}, "drawMessage"), jr = /* @__PURE__ */ g(function(e, t, a, r, i, n, s) {
  let o = 0, E = 0, T, l = 0;
  for (const x of r) {
    const u = t.get(x), O = u.box;
    T && T != O && (s || R.models.addBox(T), E += h.boxMargin + T.margin), O && O != T && (s || (O.x = o + E, O.y = i), E += O.margin), u.width = P.getMax(u.width || h.width, h.width), u.height = P.getMax(u.height || h.height, h.height), u.margin = u.margin || h.actorMargin, l = P.getMax(l, u.height), a.get(u.name) && (E += u.width / 2), u.x = o + E, u.starty = R.getVerticalPos(), R.insert(u.x, i, u.x + u.width, u.height), o += u.width + E, u.box && (u.box.width = o + O.margin - u.box.x), E = u.margin, T = u.box, R.models.addActor(u);
  }
  T && !s && R.models.addBox(T), R.bumpVerticalPos(l);
}, "addActorRenderingData"), te = /* @__PURE__ */ g(async function(e, t, a, r, i, n, s) {
  if (r) {
    let o = 0;
    ...
    R.bumpVerticalPos(o + h.boxMargin);
  } else
    for (const o of a) {
      const E = t.get(o);
  ...
  let i = 0, n = 0;
  for (const s of a) {
    const o = t.get(s), E = ea(o), T = F.drawPopup(
      e,
      o,
      E,
      h,
    ...
    T.height > i && (i = T.height), T.width + o.x > n && (n = T.width + o.x);
  }
...
function ht(e, t, a, r, i) {
  ...
  if (t.id && t.message && e[t.id]) {
    const s = e[t.id].width, o = Rt(h);
    t.message = J.wrapLabel(`[${t.message}]`, s - 2 * h.wrapPadding, o), t.width = s, t.wrap = !0;
    const E = J.calculateTextDimensions(t.message, o), T = P.getMax(E.height, h.labelBoxHeight);
    n = r + T, at.debug(`${T} - ${t.message}`);
  }
...
function ze(e, t, a, r, i, n, s) {
  ...
  if (n.get(e.to) == r) {
    ...
    o(l, x), l.starty = a - l.height / 2, R.bumpVerticalPos(l.height / 2);
...
var ta = /* @__PURE__ */ g(async function(e, t, a, r) {
  ...
  let o;
  i === "sandbox" && (o = Mt("#i" + t));
  const E = i === "sandbox" ? Mt(o.nodes()[0].contentDocument.body) : Mt("body"), T = i === "sandbox" ? o.nodes()[0].contentDocument : document;
  ...
  for (const i of t)
    if (e.get(i.to) && e.get(i.from)) {
      ...
      if (i.placement === a.db.PLACEMENT.LEFTOF && !n.prevActor || i.placement === a.db.PLACEMENT.RIGHTOF && !n.nextActor)
        continue;
      const s = i.placement !== void 0, o = !s, E = s ? Lt(h) : Rt(h), T = i.wrap ? J.wrapLabel(i.message, h.width - 2 * h.wrapPadding, E) : i.message, x = (Z(T) ? await wt(i.message, $()) : J.calculateTextDimensions(T, E)).width + 2 * h.wrapPadding;
      o && i.from === n.nextActor ? r[i.to] = P.getMax(
        r[i.to] || 0,
        x
      ) : o && i.from === n.prevActor ? r[i.from] = P.getMax(
        r[i.from] || 0,
        x
      ) : o && i.from === i.to ? (r[i.from] = P.getMax(
        r[i.from] || 0,
        x / 2
      ), r[i.to] = P.getMax(
        r[i.to] || 0,
...
async function Ge(e, t, a) {
  ...
  for (const n of e.keys()) {
    ...
    const o = Z(s.description) ? await wt(s.description, $()) : J.calculateTextDimensions(s.description, jt(h));
    s.width = s.wrap ? h.width : P.getMax(h.width, o.width + 2 * h.wrapPadding), s.height = s.wrap ? P.getMax(o.height, h.height) : h.height, r = P.getMax(r, s.height);
  }
  for (const n in t) {
    const s = e.get(n);
    if (!s)
    ...
    const T = t[n] + h.actorMargin - s.width / 2 - o.width / 2;
    s.margin = P.getMax(T, h.actorMargin);
  }
  let i = 0;
  return a.forEach((n) => {
    const s = Rt(h);
    let o = n.actorKeys.reduce((x, u) => x += e.get(u).width + (e.get(u).margin || 0), 0);
    const E = h.boxMargin * 8;
    o += E, o -= 2 * h.boxTextMargin, n.wrap && (n.name = J.wrapLabel(n.name, o - 2 * h.wrapPadding, s));
    const T = J.calculateTextDimensions(n.name, s);
    i = P.getMax(T.height, i);
    const l = P.getMax(o, T.width + 2 * h.wrapPadding);
    if (n.margin = h.boxTextMargin, o < l) {
      const x = (l - o) / 2;
      n.margin += x;
    }
...
var ra = /* @__PURE__ */ g(async function(e, t, a) {
  ...
  let E = Z(e.message) ? await wt(e.message, $()) : J.calculateTextDimensions(
    o ? J.wrapLabel(e.message, h.width, Lt(h)) : e.message,
    Lt(h)
  );
  const T = {
    width: o ? h.width : P.getMax(h.width, E.width + 2 * h.noteMargin),
    height: 0,
    startx: r.x,
    stopx: 0,
    starty: 0,
  ...
  return e.placement === a.db.PLACEMENT.RIGHTOF ? (T.width = o ? P.getMax(h.width, E.width) : P.getMax(
    r.width / 2 + i.width / 2,
    E.width + 2 * h.noteMargin
  ), T.startx = n + (r.width + h.actorMargin) / 2) : e.placement === a.db.PLACEMENT.LEFTOF ? (T.width = o ? P.getMax(h.width, E.width + 2 * h.noteMargin) : P.getMax(
    r.width / 2 + i.width / 2,
    E.width + 2 * h.noteMargin
  ), T.startx = n - T.width + (r.width - h.actorMargin) / 2) : e.to === e.from ? (E = J.calculateTextDimensions(
    o ? J.wrapLabel(e.message, P.getMax(h.width, r.width), Lt(h)) : e.message,
    Lt(h)
  ), T.width = o ? P.getMax(h.width, r.width) : P.getMax(r.width, h.width, E.width + 2 * h.noteMargin), T.startx = n + (r.width - T.width) / 2) : (T.width = Math.abs(n + r.width / 2 - (s + i.width / 2)) + h.actorMargin, T.startx = n < s ? n + r.width / 2 - h.actorMargin / 2 : s + i.width / 2 - h.actorMargin / 2), o && (T.message = J.wrapLabel(
    e.message,
  ...
  if (![
    ...
    return {};
  const [i, n] = ve(e.from, t), [s, o] = ve(e.to, t), E = i <= s;
  let T = E ? n : i, l = E ? s : o;
  ...
  const x = Math.abs(s - o) > 2, u = /* @__PURE__ */ g((_) => E ? -_ : _, "adjustValue");
  ...
  const O = [i, n, s, o], p = Math.abs(T - l);
  ...
  for (const T of e) {
    switch (T.type) {
      ...
      case r.db.LINETYPE.PAR_AND:
      case r.db.LINETYPE.CRITICAL_OPTION:
        T.message && (s = n.pop(), i[s.id] = s, i[T.id] = s, n.push(s));
        break;
      case r.db.LINETYPE.LOOP_END:
      case r.db.LINETYPE.ALT_END:
      case r.db.LINETYPE.OPT_END:
    ...
    T.placement !== void 0 ? (o = await ra(T, t, r), T.noteModel = o, n.forEach((x) => {
      s = x, s.from = P.getMin(s.from, o.startx), s.to = P.getMax(s.to, o.startx + o.width), s.width = P.getMax(s.width, Math.abs(s.from - s.to)) - h.labelBoxWidth;
    })) : (E = na(T, t, r), T.msgModel = E, E.startx && E.stopx && n.length > 0 && n.forEach((x) => {
