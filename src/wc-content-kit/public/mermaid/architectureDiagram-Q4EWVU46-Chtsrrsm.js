import { _ as dt, I as Be, Y as ke, l as Re, b as Ze, a as qe, p as Qe, q as Je, g as Ke, s as je, z as _e, F as tr, G as er, D as rr, c as ye, ak as Ee, aJ as ve, i as ir, d as ar, x as nr, aK as or, aL as sr } from "./mermaid.core-Jw3znkh4.js";
import { p as hr } from "./chunk-4BX2VUAB-OP5xfQzz.js";
import { p as lr } from "./mermaid-parser.core-DQ6c91Zg.js";
import { c as Se } from "./cytoscape.esm-p9_IyyOE.js";
import { g as fr } from "./index.js";
var se = { exports: {} }, he = { exports: {} }, le = { exports: {} }, cr = le.exports, we;
function gr() {
  return we || (we = 1, (function(C, P) {
    (function(U, L) {
      C.exports = L();
    })(cr, function() {
      return (
        ...
        (function(w) {
          ...
          (function(w, U, L) {
            ...
            r.prototype.getEdges = function() {
              ...
              t = e.WORLD_CENTER_X + i.nextDouble() * (c - s) + s;
              var l = -e.INITIAL_WORLD_BOUNDARY, T = e.INITIAL_WORLD_BOUNDARY;
              o = e.WORLD_CENTER_Y + i.nextDouble() * (T - l) + l, this.rect.x = t, this.rect.y = o;
          ...
          (function(w, U, L) {
            ...
            o.prototype.getNodes = function() {
              ...
              if (c instanceof i) {
                ...
                var A = g.source.edges.indexOf(g), G = g.target.edges.indexOf(g);
                if (!(A > -1 && G > -1))
                  throw "Source and/or target doesn't know this edge!";
                g.source.edges.splice(A, 1), g.target != g.source && g.target.edges.splice(G, 1);
              ...
              for (var c = h.MAX_VALUE, l = h.MAX_VALUE, T, g, d, N = this.getNodes(), F = N.length, A = 0; A < F; A++) {
                var G = N[A];
              ...
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, d = -h.MAX_VALUE, N, F, A, G, k, X = this.nodes, J = X.length, D = 0; D < J; D++) {
                var rt = X[D];
                c && rt.child != null && rt.updateBounds(), N = rt.getLeft(), F = rt.getRight(), A = rt.getTop(), G = rt.getBottom(), l > N && (l = N), T < F && (T = F), g > A && (g = A), d < G && (d = G);
              }
              ...
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, d = -h.MAX_VALUE, N, F, A, G, k = c.length, X = 0; X < k; X++) {
                var J = c[X];
                N = J.getLeft(), F = J.getRight(), A = J.getTop(), G = J.getBottom(), l > N && (l = N), T < F && (T = F), g > A && (g = A), d < G && (d = G);
              }
          ...
          (function(w, U, L) {
            ...
            a.prototype.addRoot = function() {
              ...
              for (var e, i, f, r, v, t = this.getAllEdges(), o = t.length, s = 0; s < o; s++) {
                if (e = t[s], i = e.source, f = e.target, e.lca = null, e.sourceInLca = i, e.targetInLca = f, i == f) {
                  e.lca = i.getOwner();
                  continue;
                }
          ...
          (function(w, U, L) {
            ...
            h.calcSeparationAmount = function(a, e, i, f) {
              ...
              var t = v * i[0], o = i[1] / v;
              i[0] < o ? o = i[0] : t = i[1], i[0] = -1 * r[0] * (o / 2 + f), i[1] = -1 * r[1] * (t / 2 + f);
              ...
              var o = a.getX(), s = a.getY(), c = a.getRight(), l = a.getX(), T = a.getBottom(), g = a.getRight(), d = a.getWidthHalf(), N = a.getHeightHalf(), F = e.getX(), A = e.getY(), G = e.getRight(), k = e.getX(), X = e.getBottom(), J = e.getRight(), D = e.getWidthHalf(), rt = e.getHeightHalf(), n = !1, m = !1;
              if (f === v) {
                if (r > t)
                  return i[0] = f, i[1] = s, i[2] = v, i[3] = X, !1;
                if (r < t)
                  return i[0] = f, i[1] = T, i[2] = v, i[3] = A, !1;
              } else if (r === t) {
                if (f > v)
                  return i[0] = o, i[1] = r, i[2] = G, i[3] = t, !1;
                if (f < v)
                  return i[0] = c, i[1] = r, i[2] = F, i[3] = t, !1;
              } else {
                var p = a.height / a.width, E = e.height / e.width, y = (t - r) / (v - f), I = void 0, M = void 0, R = void 0, W = void 0, x = void 0, q = void 0;
                if (-p === y ? f > v ? (i[0] = l, i[1] = T, n = !0) : (i[0] = c, i[1] = s, n = !0) : p === y && (f > v ? (i[0] = o, i[1] = s, n = !0) : (i[0] = g, i[1] = T, n = !0)), -E === y ? v > f ? (i[2] = k, i[3] = X, m = !0) : (i[2] = G, i[3] = A, m = !0) : E === y && (v > f ? (i[2] = F, i[3] = A, m = !0) : (i[2] = J, i[3] = X, m = !0)), n && m)
                  return !1;
                ...
                if (!m)
                  switch (M) {
                    case 1:
                      q = A, x = v + -rt / y, i[2] = x, i[3] = q;
                      break;
                    case 2:
                      x = J, q = t + D * y, i[2] = x, i[3] = q;
                      break;
                    case 3:
                      q = X, x = v + rt / y, i[2] = x, i[3] = q;
                      break;
                    case 4:
              ...
              var r = a.x, v = a.y, t = e.x, o = e.y, s = i.x, c = i.y, l = f.x, T = f.y, g = void 0, d = void 0, N = void 0, F = void 0, A = void 0, G = void 0, k = void 0, X = void 0, J = void 0;
              return N = o - v, A = r - t, k = t * v - r * o, F = T - c, G = s - l, X = l * c - s * T, J = N * G - F * A, J === 0 ? null : (g = (A * X - G * k) / J, d = (F * k - N * X) / J, new u(g, d));
              ...
              var r = a.x, v = a.y, t = e.x, o = e.y, s = i.x, c = i.y, l = f.x, T = f.y, g = (t - r) * (T - c) - (l - s) * (o - v);
              if (g === 0)
                return !1;
              var d = ((T - c) * (l - r) + (s - l) * (T - v)) / g, N = ((v - o) * (l - r) + (t - r) * (T - v)) / g;
              return 0 < d && d < 1 && 0 < N && N < 1;
            }, h.findCircleLineIntersections = function(a, e, i, f, r, v, t) {
              var o = (i - a) * (i - a) + (f - e) * (f - e), s = 2 * ((a - r) * (i - a) + (e - v) * (f - e)), c = (a - r) * (a - r) + (e - v) * (e - v) - t * t, l = s * s - 4 * o * c;
              if (l >= 0) {
          ...
          (function(w, U, L) {
            var u = /* @__PURE__ */ (function() {
              ...
              return function(v, t, o) {
                return t && r(v.prototype, t), o && r(v, o), v;
              };
            })();
            function h(r, v) {
              if (!(r instanceof v))
            ...
            var a = function(v) {
              ...
              function r(v) {
                var t = this;
                h(this, r), this.length = 0, this.head = null, this.tail = null, v?.forEach(function(o) {
                  return t.push(o);
                });
              }
              return u(r, [{
            ...
            o.RANDOM_SEED = 1, o.prototype = Object.create(t.prototype), o.prototype.getGraphManager = function() {
              ...
              for (A = A.concat(l); A.length > 0 && c; ) {
                for (N.push(A[0]); N.length > 0 && c; ) {
                  ...
                  for (var k = G.getEdges(), g = 0; g < k.length; g++) {
                    var X = k[g].getOtherEnd(G);
                    if (F.get(G) != X)
                      if (!d.has(X))
                        N.push(X), F.set(X, G);
                      else {
              ...
              for (var c = 0; c < s.length; c++) {
                ...
                if (l.bendpoints.length > 0) {
                  for (var T = this.edgeToDummyNodes.get(l), g = 0; g < T.length; g++) {
                    var d = T[g], N = new r(d.getCenterX(), d.getCenterY()), F = l.bendpoints.get(g);
          ...
          (function(w, U, L) {
            ...
            r.prototype.initParameters = function() {
              ...
              for (var t, o, s, c, l, T, g, d = this.getGraphManager().getAllEdges(), N = 0; N < d.length; N++)
                t = d[N], o = t.idealLength, t.isInterGraph && (c = t.getSource(), l = t.getTarget(), T = t.getSourceInLca().getEstimatedSize(), g = t.getTargetInLca().getEstimatedSize(), this.useSmartIdealEdgeLengthCalculation && (t.idealLength += T + g - 2 * e.SIMPLE_NODE_SIZE), s = t.getLca().getInclusionTreeDepth(), t.idealLength += o * a.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR * (c.getInclusionTreeDepth() + l.getInclusionTreeDepth() - 2 * s));
              ...
              for (var t = this.getAllNodes(), o, s = 0; s < t.length; s++)
                o = t[s], o.move();
            }, r.prototype.calcSpringForce = function(t, o) {
            ...
            }, r.prototype.calcRepulsionForce = function(t, o) {
              var s = t.getRect(), c = o.getRect(), l = new Array(2), T = new Array(4), g, d, N, F, A, G, k;
              if (s.intersects(c)) {
                i.calcSeparationAmount(s, c, l, a.DEFAULT_EDGE_LENGTH / 2), G = 2 * l[0], k = 2 * l[1];
                ...
                this.uniformLeafNodeSizes && t.getChild() == null && o.getChild() == null ? (g = c.getCenterX() - s.getCenterX(), d = c.getCenterY() - s.getCenterY()) : (i.getIntersection(s, c, T), g = T[2] - T[0], d = T[3] - T[1]), Math.abs(g) < a.MIN_REPULSION_DIST && (g = f.sign(g) * a.MIN_REPULSION_DIST), Math.abs(d) < a.MIN_REPULSION_DIST && (d = f.sign(d) * a.MIN_REPULSION_DIST), N = g * g + d * d, F = Math.sqrt(N), A = (t.nodeRepulsion / 2 + o.nodeRepulsion / 2) * t.noOfChildren * o.noOfChildren / N, G = A * g / F, k = A * d / F, t.repulsionForceX -= G, t.repulsionForceY -= k, o.repulsionForceX += G, o.repulsionForceY += k;
              ...
              for (var l = 0; l < o; l++)
                for (var T = 0; T < s; T++)
                  c[l][T] = new Array();
              return c;
            }, r.prototype.addNodeToGrid = function(t, o, s) {
              var c = 0, l = 0, T = 0, g = 0;
            ...
            }, r.prototype.calculateRepulsionForceOfANode = function(t, o, s, c) {
            ...
            var a = L(11), e = (function() {
              ...
              return u(i, [{
                ...
                value: function(r, v, t) {
                  if (v < t) {
                    var o = this._partition(r, v, t);
                    this._quicksort(r, v, o), this._quicksort(r, o + 1, t);
                  }
                }
              }, {
                key: "_partition",
                value: function(r, v, t) {
                  for (var o = this._get(r, v), s = v, c = t; ; ) {
                    for (; this.compareFunction(o, this._get(r, c)); )
                      c--;
                    for (; this.compareFunction(this._get(r, s), o); )
                      s++;
                    if (s < c)
                      this._swap(r, s, c), s++, c--;
                    else return c;
                  }
                }
              }, {
                ...
                value: function(r, v, t) {
                  var o = this._get(r, v);
                  this._set(r, v, this._get(r, t)), this._set(r, t, o);
                }
              }, {
            ...
            u.svd = function(h) {
              ...
              for (var $ = n - 1, _ = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
                ...
                switch (Q++, It) {
                  ...
                  case 3:
                    {
                      var Yt = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])), Math.abs(e[n - 2])), Math.abs(this.s[Q])), Math.abs(e[Q])), Vt = this.s[n - 1] / Yt, S = this.s[n - 2] / Yt, b = e[n - 2] / Yt, B = this.s[Q] / Yt, K = e[Q] / Yt, Z = ((S + Vt) * (S - Vt) + b * b) / 2, at = Vt * b * (Vt * b), ct = 0;
        ...
        (() => {
          var U = {
            ...
            765: (
              /***/
              ((a, e, i) => {
                var f = i(551).FDLayout, r = i(578), v = i(880), t = i(991), o = i(767), s = i(806), c = i(902), l = i(551).FDLayoutConstants, T = i(551).LayoutConstants, g = i(551).Point, d = i(551).PointD, N = i(551).DimensionD, F = i(551).Layout, A = i(551).Integer, G = i(551).IGeometry, k = i(551).LGraph, X = i(551).Transform, J = i(551).LinkedList;
                function D() {
                ...
                D.prototype.newGraphManager = function() {
                  ...
                  for (var m = new g(0, 0), p = Math.ceil(Math.sqrt(n.length)), E = 0, y = 0, I = 0, M = new d(0, 0), R = 0; R < n.length; R++) {
                    ...
                    m.x = I, m.y = y, M = D.radialLayout(W, x, m), M.y > E && (E = Math.floor(M.y)), I = Math.floor(M.x + s.DEFAULT_COMPONENT_SEPERATION);
                  }
                  ...
                  var M = (E - p + 1) / 2;
                  M < 0 && (M += 180);
                  var R = (M + p) % 360, W = R * G.TWO_PI / 360, x = y * Math.cos(W), q = y * Math.sin(W);
                  n.setCenter(x, q);
                  var V = [];
                  ...
                  var p = s.TILING_PADDING_VERTICAL, E = s.TILING_PADDING_HORIZONTAL, y = n.length, I = 0, M = 0, R = 0;
                  n.forEach(function(z) {
                    I += z.getWidth(), M += z.getHeight(), z.getWidth() > R && (R = z.getWidth());
                  });
                  var W = I / y, x = M / y, q = Math.pow(p - E, 2) + 4 * (W + E) * (x + p) * y, V = (E - p + Math.sqrt(q)) / (2 * (W + E)), Y;
                  m ? (Y = Math.ceil(V), Y == V && Y++) : Y = Math.floor(V);
                  var et = Y * (W + E) - E;
                  return R > et && (et = R), et += E * 2, et;
                }, D.prototype.tileNodesByFavoringDim = function(n, m, p) {
                  var E = s.TILING_PADDING_VERTICAL, y = s.TILING_PADDING_HORIZONTAL, I = s.TILING_COMPARE_BY, M = {
                    rows: [],
                    rowWidth: [],
                    rowHeight: [],
                    width: 0,
                  ...
                  n.sort(function(z, O) {
                    var H = W;
                    return M.idealRowWidth ? (H = I, H(z.id, O.id)) : H(z, O);
                  });
                  ...
                  if (E == n[1].source ? p = n[1].target : p = n[1].source, s.PURE_INCREMENTAL)
                    ...
                    var y = p.startX, I = p.finishX, M = p.startY, R = p.finishY, W = 0, x = 0, q = 0, V = 0, Y = [W, q, x, V];
                    if (M > 0)
                      for (var et = y; et <= I; et++)
                        Y[0] += this.grid[et][M - 1].length + this.grid[et][M].length - 1;
                    if (I < this.grid.length - 1)
                      for (var et = M; et <= R; et++)
            ...
            902: (
              ...
              ((a, e, i) => {
                ...
                var r = i(806), v = i(551).LinkedList, t = i(551).Matrix, o = i(551).SVD;
                function s() {
                }
                s.handleConstraints = function(c) {
                  ...
                  for (var T = /* @__PURE__ */ new Map(), g = /* @__PURE__ */ new Map(), d = [], N = [], F = c.getAllNodes(), A = 0, G = 0; G < F.length; G++) {
                    var k = F[G];
                    k.getChild() == null && (g.set(k.id, A++), d.push(k.getCenterX()), N.push(k.getCenterY()), T.set(k.id, k));
                  }
                  l.relativePlacementConstraint && l.relativePlacementConstraint.forEach(function(S) {
                    !S.gap && S.gap != 0 && (S.left ? S.gap = r.DEFAULT_EDGE_LENGTH + T.get(S.left).getWidth() / 2 + T.get(S.right).getWidth() / 2 : S.gap = r.DEFAULT_EDGE_LENGTH + T.get(S.top).getHeight() / 2 + T.get(S.bottom).getHeight() / 2);
                  });
                  var X = function(b, B) {
                    return { x: b.x - B.x, y: b.y - B.y };
                  }, J = function(b) {
                    var B = 0, K = 0;
                    return b.forEach(function(Z) {
                      B += d[g.get(Z)], K += N[g.get(Z)];
                    }), { x: B / b.size, y: K / b.size };
                  }, D = function(b, B, K, Z, at) {
                    function ct(lt, ot) {
                    ...
                    var tt = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), ut = new v();
                    nt.forEach(function(lt, ot) {
                      lt == 0 ? (ut.push(ot), K || (B == "horizontal" ? tt.set(ot, g.has(ot) ? d[g.get(ot)] : Z.get(ot)) : tt.set(ot, g.has(ot) ? N[g.get(ot)] : Z.get(ot)))) : tt.set(ot, Number.NEGATIVE_INFINITY), K && j.set(ot, /* @__PURE__ */ new Set([ot]));
                      ...
                      if (lt.forEach(function(st) {
                        ...
                        ot.forEach(function(st) {
                          B == "horizontal" ? (tt.set(st, g.has(st) ? d[g.get(st)] : Z.get(st)), Lt += tt.get(st)) : (tt.set(st, g.has(st) ? N[g.get(st)] : Z.get(st)), Lt += tt.get(st));
                        ...
                        lt.forEach(function(st) {
                          B == "horizontal" ? ft += g.has(st) ? d[g.get(st)] : Z.get(st) : ft += g.has(st) ? N[g.get(st)] : Z.get(st);
                    ...
                    for (var wt = function() {
                      var ot = ut.shift(), Lt = b.get(ot);
                      Lt.forEach(function(ft) {
                        if (tt.get(ft.id) < tt.get(ot) + ft.gap)
                          if (K && K.has(ft.id)) {
                            var st = void 0;
                            if (B == "horizontal" ? st = g.has(ft.id) ? d[g.get(ft.id)] : Z.get(ft.id) : st = g.has(ft.id) ? N[g.get(ft.id)] : Z.get(ft.id), tt.set(ft.id, st), st < tt.get(ot) + ft.gap) {
                      ...
                      j.forEach(function(lt, ot) {
                        ...
                        try {
                          for (var bt = lt[Symbol.iterator](), zt; !(Tt = (zt = bt.next()).done); Tt = !0) {
                            ...
                            B == "horizontal" ? kt = g.has(St) ? d[g.get(St)] : Z.get(St) : kt = g.has(St) ? N[g.get(St)] : Z.get(St);
                            var Kt = tt.get(St);
                    ...
                    if (b.forEach(function(j) {
                      j.left ? d[g.get(j.left)] - d[g.get(j.right)] >= 0 ? B++ : K++ : N[g.get(j.top)] - N[g.get(j.bottom)] >= 0 ? Z++ : at++;
                    }), B > K && Z > at)
                    ...
                    var B = [], K = new v(), Z = /* @__PURE__ */ new Set(), at = 0;
                    return b.forEach(function(ct, nt) {
                      if (!Z.has(nt)) {
                        B[at] = [];
                        var tt = nt;
                    ...
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1)
                      ...
                      (function() {
                        ...
                        if (l.alignmentConstraint.vertical) {
                          for (var b = l.alignmentConstraint.vertical, B = function(tt) {
                            var j = /* @__PURE__ */ new Set();
                            b[tt].forEach(function(pt) {
                              j.add(pt);
                            });
                            var ut = new Set([].concat(f(j)).filter(function(pt) {
                              return R.has(pt);
                            })), wt = void 0;
                            ut.size > 0 ? wt = d[g.get(ut.values().next().value)] : wt = J(j).x, b[tt].forEach(function(pt) {
                              E[S] = [wt, N[g.get(pt)]], y[S] = [d[g.get(pt)], N[g.get(pt)]], S++;
                            });
                          }, K = 0; K < b.length; K++)
                            B(K);
                          I = !0;
                        ...
                        if (l.alignmentConstraint.horizontal) {
                          for (var Z = l.alignmentConstraint.horizontal, at = function(tt) {
                            ...
                            ut.size > 0 ? wt = d[g.get(ut.values().next().value)] : wt = J(j).y, Z[tt].forEach(function(pt) {
                              E[S] = [d[g.get(pt)], wt], y[S] = [d[g.get(pt)], N[g.get(pt)]], S++;
                            });
                          }, ct = 0; ct < Z.length; ct++)
                            at(ct);
                          I = !0;
                      ...
                      if (V < x.size / 2)
                        rt(l.relativePlacementConstraint), I = !1, M = !1;
                      else {
                  ...
                  if (r.ENFORCE_CONSTRAINTS) {
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 0) {
                      var Et = { x: 0, y: 0 };
                      l.fixedNodeConstraint.forEach(function(S, b) {
                        var B = { x: d[g.get(S.nodeId)], y: N[g.get(S.nodeId)] }, K = S.position, Z = X(K, B);
                        Et.x += Z.x, Et.y += Z.y;
                      }), Et.x /= l.fixedNodeConstraint.length, Et.y /= l.fixedNodeConstraint.length, d.forEach(function(S, b) {
                        d[b] += Et.x;
                    ...
                    if (l.alignmentConstraint) {
                      if (l.alignmentConstraint.vertical)
                        for (var Dt = l.alignmentConstraint.vertical, Rt = function(b) {
                          var B = /* @__PURE__ */ new Set();
                          Dt[b].forEach(function(at) {
                            B.add(at);
                          });
                          var K = new Set([].concat(f(B)).filter(function(at) {
                            return R.has(at);
                          })), Z = void 0;
                          K.size > 0 ? Z = d[g.get(K.values().next().value)] : Z = J(B).x, B.forEach(function(at) {
                            R.has(at) || (d[g.get(at)] = Z);
                          });
                        }, Ht = 0; Ht < Dt.length; Ht++)
                          Rt(Ht);
                      if (l.alignmentConstraint.horizontal)
                        for (var Ut = l.alignmentConstraint.horizontal, Pt = function(b) {
                          var B = /* @__PURE__ */ new Set();
                          Ut[b].forEach(function(at) {
                            B.add(at);
                          });
                          var K = new Set([].concat(f(B)).filter(function(at) {
                            return R.has(at);
                          ...
                          K.size > 0 ? Z = N[g.get(K.values().next().value)] : Z = J(B).y, B.forEach(function(at) {
                            R.has(at) || (N[g.get(at)] = Z);
                          });
                        }, Ft = 0; Ft < Ut.length; Ft++)
                          Pt(Ft);
                    }
                    l.relativePlacementConstraint && (function() {
                      var S = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), at = /* @__PURE__ */ new Map(), ct = /* @__PURE__ */ new Set(), nt = /* @__PURE__ */ new Set();
                        ...
                        if (l.alignmentConstraint.vertical)
                          for (var tt = l.alignmentConstraint.vertical, j = function(yt) {
                            B.set("dummy" + yt, []), tt[yt].forEach(function(Mt) {
                              S.set(Mt, "dummy" + yt), B.get("dummy" + yt).push(Mt), R.has(Mt) && ct.add("dummy" + yt);
                            }), Z.set("dummy" + yt, d[g.get(tt[yt][0])]);
                          }, ut = 0; ut < tt.length; ut++)
                            j(ut);
                        if (l.alignmentConstraint.horizontal)
                          for (var wt = l.alignmentConstraint.horizontal, pt = function(yt) {
                            K.set("dummy" + yt, []), wt[yt].forEach(function(Mt) {
                              b.set(Mt, "dummy" + yt), K.get("dummy" + yt).push(Mt), R.has(Mt) && nt.add("dummy" + yt);
                      ...
                      var _t = D(lt, "horizontal", ct, Z, Qt), Jt = D(ot, "vertical", nt, at, jt), ne = function(yt) {
        ...
        (() => {
          var U = {
            ...
            548: (
              ...
              ((a, e, i) => {
                ...
                v.getTopMostNodes = function(t) {
                  ...
                  var l = new r(), T = /* @__PURE__ */ new Set(), g = [], d = void 0, N = void 0, F = void 0, A = !1, G = 1, k = [], X = [], J = function() {
                    var rt = t.collection();
                    X.push(rt);
                      ...
                      for (var M = 0; M < I.length; M++) {
                        ...
                        if (d = s.intersection(R.union(R.ancestors())), d != null && !T.has(d[0])) {
                          ...
                          W.forEach(function(x) {
                            l.push(x), T.add(x), rt.merge(x), s.has(x) && g.push(x);
                          });
                        }
                      }
                    }; l.length != 0; )
                    ...
                    if (s.quality == "draft") {
                      ...
                      try {
                        for (var A = o.nodeIndexes[Symbol.iterator](), G; !(d = (G = A.next()).done); d = !0) {
                          var k = G.value, X = f(k, 2), J = X[0], D = X[1], rt = s.cy.getElementById(J);
                          if (rt) {
                  ...
                  for (var l = Number.MAX_SAFE_INTEGER, T = Number.MIN_SAFE_INTEGER, g = Number.MAX_SAFE_INTEGER, d = Number.MIN_SAFE_INTEGER, N = void 0, F = void 0, A = void 0, G = void 0, k = t.descendants().not(":parent"), X = k.length, J = 0; J < X; J++) {
                    var D = k[J];
                    N = o[c.get(D.id())] - D.width() / 2, F = o[c.get(D.id())] + D.width() / 2, A = s[c.get(D.id())] - D.height() / 2, G = s[c.get(D.id())] + D.height() / 2, l > N && (l = N), T < F && (T = F), g > A && (g = A), d < G && (d = G);
                  }
                  var rt = {};
                  return rt.topLeftX = l, rt.topLeftY = g, rt.width = T - l, rt.height = d - g, rt;
            ...
            816: (
              /***/
              ((a, e, i) => {
                var f = i(548), r = i(140).CoSELayout, v = i(140).CoSENode, t = i(140).layoutBase.PointD, o = i(140).layoutBase.DimensionD, s = i(140).layoutBase.LayoutConstants, c = i(140).layoutBase.FDLayoutConstants, l = i(140).CoSEConstants, T = function(d, N) {
                  var F = d.cy, A = d.eles, G = A.nodes(), k = A.edges(), X = void 0, J = void 0, D = void 0, rt = {};
                  d.randomize && (X = N.nodeIndexes, J = N.xCoords, D = N.yCoords);
                  var n = function(x) {
                    ...
                    for (var et = q.length, z = 0; z < et; z++) {
                      ...
                      if (O.outerWidth() != null && O.outerHeight() != null)
                        if (Y.randomize)
                          if (!O.isParent())
                            $ = x.add(new v(V.graphManager, new t(J[X.get(O.id())] - _.w / 2, D[X.get(O.id())] - _.h / 2), new o(parseFloat(_.w), parseFloat(_.h))));
                          else {
                            var ht = f.calcBoundingBox(O, J, D, X);
                  ...
                  return E(R.addRoot(), f.getTopMostNodes(G), M, d), y(M, R, k), I(M, d), M.runLayout(), rt;
                };
            ...
            212: (
              ...
              ((a, e, i) => {
                ...
                var v = i(658), t = i(548), o = i(657), s = o.spectralLayout, c = i(816), l = c.coseLayout, T = Object.freeze({
                  ...
                  return f(d, [{
                    key: "run",
                    value: function() {
                      var F = this, A = this.options, G = A.cy, k = A.eles, X = [], J = [], D = void 0, rt = [];
                      ...
                      if (G.layoutUtilities && A.packComponents && (m = G.layoutUtilities("get"), m || (m = G.layoutUtilities()), p = !0), k.nodes().length > 0)
                        if (p) {
                          ...
                          if (D = t.connectComponents(G, A.eles, I), D.forEach(function(vt) {
                            ...
                            if (A.tile) {
                              ...
                              if (D.forEach(function(vt, it) {
                                ...
                                rt.push({ x: et.x1 + et.w / 2, y: et.y1 + et.h / 2 }), D.push(M), X.push(V);
                                for (var z = Y.length - 1; z >= 0; z--)
                                  D.splice(Y[z], 1), X.splice(Y[z], 1), rt.splice(Y[z], 1);
                              }
                            }
                            D.forEach(function(vt, it) {
                              A.eles = vt, J.push(l(A, X[it])), t.relocateComponent(rt[it], J[it], A);
                            });
                          } else
                            D.forEach(function(vt, it) {
                              t.relocateComponent(rt[it], X[it], A);
                            });
                          ...
                          if (rt.push({ x: E.x1 + E.w / 2, y: E.y1 + E.h / 2 }), A.randomize) {
                            var y = s(A);
                            X.push(y);
                          }
                          A.quality == "default" || A.quality == "proof" ? (J.push(l(A, X[0])), t.relocateComponent(rt[0], J[0], A)) : t.relocateComponent(rt[0], X[0], A);
                        }
                      ...
                      if (A.quality == "default" || A.quality == "proof" || A.randomize) {
                        ...
                        A.eles = k.not(Nt), k.nodes().not(":parent").not(Nt).layoutPositions(F, A, Q), It.length > 0 && It.forEach(function(vt) {
                          vt.position(Q(vt));
                        });
                      } else
            ...
            657: (
              /***/
              ((a, e, i) => {
                var f = i(548), r = i(140).layoutBase.Matrix, v = i(140).layoutBase.SVD, t = function(s) {
                  var c = s.cy, l = s.eles, T = l.nodes(), g = l.nodes(":parent"), d = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), A = [], G = [], k = [], X = [], J = [], D = [], rt = [], n = [], m = void 0, p = 1e8, E = 1e-9, y = s.piTol, I = s.samplingType, M = s.nodeSeparation, R = void 0, W = function() {
                    for (var b = 0, B = 0, K = !1; B < R; ) {
                      b = Math.floor(Math.random() * m), K = !1;
                      for (var Z = 0; Z < B; Z++)
                        if (X[Z] == b) {
                          K = !0;
                          break;
                    ...
                    for (var b = v.svd(rt), B = b.S, K = b.U, Z = b.V, at = B[0] * B[0] * B[0], ct = [], nt = 0; nt < R; nt++) {
                      ct[nt] = [];
                      for (var tt = 0; tt < R; tt++)
                    ...
                    for (var b = void 0, B = void 0, K = [], Z = [], at = [], ct = [], nt = 0; nt < m; nt++)
                      K[nt] = Math.random(), Z[nt] = Math.random();
                    K = r.normalize(K), Z = r.normalize(Z);
                    for (var tt = E, j = E, ut = void 0; ; ) {
                      for (var wt = 0; wt < m; wt++)
                        at[wt] = K[wt];
                      if (K = r.multGamma(r.multL(r.multGamma(at), D, n)), b = r.dotProduct(at, K), K = r.normalize(K), tt = r.dotProduct(at, K), ut = Math.abs(tt / j), ut <= 1 + y && ut >= 1)
                        break;
                      j = tt;
                    }
                    ...
                    for (var lt = 0; lt < m; lt++)
                      ct[lt] = Z[lt];
                    G = r.multCons(at, Math.sqrt(Math.abs(b))), k = r.multCons(ct, Math.sqrt(Math.abs(B)));
                  };
                  ...
                  g.forEach(function(S) {
                    ...
                    var B = 0, K = b.nodes(":childless")[0].connectedEdges().length;
                    b.nodes(":childless").forEach(function(Z, at) {
                      Z.connectedEdges().length < K && (K = Z.connectedEdges().length, B = at);
                    }), F.set(S.id(), b.nodes(":childless")[B].id());
                  }), T.forEach(function(S) {
                    var b = void 0;
                    S.isParent() ? b = N.get(F.get(S.id())) : b = N.get(S.id()), S.neighborhood().nodes().forEach(function(B) {
                      l.intersection(S.edgesWith(B)).length > 0 && (B.isParent() ? A[b].push(F.get(B.id())) : A[b].push(B.id()));
                    });
                  });
                  var Nt = function(b) {
                    var B = N.get(b), K = void 0;
                    d.get(b).forEach(function(Z) {
                      c.getElementById(Z).isParent() ? K = F.get(Z) : K = Z, A[B].push(K), A[N.get(K)].push(b);
                    });
                  }, vt = !0, it = !1, gt = void 0;
                  try {
                  ...
                  if (m > 2) {
                    ...
                    for (var Rt = 0; Rt < R; Rt++)
                      n[Rt] = [];
                    return s.quality == "draft" || s.step == "all" ? (q(I), V(), Y(), Et = { nodeIndexes: N, xCoords: G, yCoords: k }) : (N.forEach(function(S, b) {
                      G.push(c.getElementById(b).position("x")), k.push(c.getElementById(b).position("y"));
                    }), Et = { nodeIndexes: N, xCoords: G, yCoords: k }), Et;
                  } else {
                    ...
                    return Et = { nodeIndexes: N, xCoords: G, yCoords: k }, Et;
                  }
                };
...
var De = {
  ...
  L: /* @__PURE__ */ dt((C, P) => C - P + 2, "L"),
  R: /* @__PURE__ */ dt((C, P) => C - 2, "R"),
  T: /* @__PURE__ */ dt((C, P) => C - P + 2, "T"),
  B: /* @__PURE__ */ dt((C, P) => C - 2, "B")
}, mr = /* @__PURE__ */ dt(function(C) {
  return Wt(C) ? C === "L" ? "R" : "L" : C === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), Ie = /* @__PURE__ */ dt(function(C) {
  const P = C;
  return P === "L" || P === "R" || P === "T" || P === "B";
  ...
  const P = C;
  return P === "T" || P === "B";
}, "isArchitectureDirectionY"), me = /* @__PURE__ */ dt(function(C, P) {
  const w = Wt(C) && qt(P), U = qt(C) && Wt(P);
  return w || U;
}, "isArchitectureDirectionXY"), Tr = /* @__PURE__ */ dt(function(C) {
  const P = C[0], w = C[1], U = Wt(P) && qt(w), L = qt(P) && Wt(w);
  return U || L;
}, "isArchitecturePairXY"), Nr = /* @__PURE__ */ dt(function(C) {
  return C !== "LL" && C !== "RR" && C !== "TT" && C !== "BB";
}, "isValidArchitectureDirectionPair"), pe = /* @__PURE__ */ dt(function(C, P) {
  const w = `${C}${P}`;
  return Nr(w) ? w : void 0;
}, "getArchitectureDirectionPair"), Lr = /* @__PURE__ */ dt(function([C, P], w) {
  const U = w[0], L = w[1];
  return Wt(U) ? qt(L) ? [C + (U === "L" ? -1 : 1), P + (L === "T" ? 1 : -1)] : [C + (U === "L" ? -1 : 1), P] : Wt(L) ? [C + (L === "L" ? 1 : -1), P + (U === "T" ? 1 : -1)] : [C, P + (U === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), Cr = /* @__PURE__ */ dt(function(C) {
  return C === "LT" || C === "TL" ? [1, 1] : C === "BL" || C === "LB" ? [1, -1] : C === "BR" || C === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), Ar = /* @__PURE__ */ dt(function(C, P) {
  return me(C, P) ? "bend" : Wt(C) ? "horizontal" : "vertical";
...
}, "isArchitectureJunction"), Fe = /* @__PURE__ */ dt((C) => C.data(), "edgeData"), ie = /* @__PURE__ */ dt((C) => C.data(), "nodeData"), Or = er.architecture, be = class {
  constructor() {
    this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.elements = {}, this.diagramId = "", this.setAccTitle = Ze, this.getAccTitle = qe, this.setDiagramTitle = Qe, this.getDiagramTitle = Je, this.getAccDescription = Ke, this.setAccDescription = je, this.clear();
  }
  static {
  ...
  addGroup({ id: C, icon: P, in: w, title: U }) {
    if (this.registeredIds?.[C] !== void 0)
      throw new Error(
  ...
  addEdge({
    ...
    if (!Ie(w))
      throw new Error(
        `Invalid direction given for left hand side of edge ${C}--${P}. Expected (L,R,T,B) got ${String(w)}`
      );
    if (!Ie(U))
      throw new Error(
        `Invalid direction given for right hand side of edge ${C}--${P}. Expected (L,R,T,B) got ${String(U)}`
      );
    ...
    if (this.nodes[P] === void 0 && this.groups[P] === void 0)
      throw new Error(
        `The right-hand id [${P}] does not yet exist. Please create the service/group before declaring an edge to it.`
      );
    const i = this.nodes[C].in, f = this.nodes[P].in;
    if (h && i && f && i == f)
      throw new Error(
    ...
    if (a && i && f && i == f)
      throw new Error(
        `The right-hand id [${P}] is modified to traverse the group boundary, but the edge does not pass through two groups.`
      );
    const r = {
      lhsId: C,
      lhsDir: w,
    ...
    this.edges.push(r), this.nodes[C] && this.nodes[P] && (this.nodes[C].edges.push(this.edges[this.edges.length - 1]), this.nodes[P].edges.push(this.edges[this.edges.length - 1]));
  }
  getEdges() {
    return this.edges;
  }
  ...
  getDataStructures() {
    if (this.dataStructures === void 0) {
      const C = {}, P = Object.entries(this.nodes).reduce((a, [e, i]) => (a[e] = i.edges.reduce((f, r) => {
        const v = this.getNode(r.lhsId)?.in, t = this.getNode(r.rhsId)?.in;
        if (v && t && v !== t) {
          const o = Ar(r.lhsDir, r.rhsDir);
          o !== "bend" && (C[v] ??= {}, C[v][t] = o, C[t] ??= {}, C[t][v] = o);
        }
        if (r.lhsId === e) {
          const o = pe(r.lhsDir, r.rhsDir);
          o && (f[o] = r.rhsId);
        } else {
          const o = pe(r.rhsDir, r.lhsDir);
          o && (f[o] = r.lhsId);
        }
        return f;
      }, {}), a), {}), w = Object.keys(P)[0], U = { [w]: 1 }, L = Object.keys(P).reduce(
        (a, e) => e === w ? a : { ...a, [e]: 1 },
        {}
      ), u = /* @__PURE__ */ dt((a) => {
        const e = { [a]: [0, 0] }, i = [a];
  ...
  hr(C, P), C.groups.map((w) => P.addGroup(w)), C.services.map((w) => P.addService({ ...w, type: "service" })), C.junctions.map((w) => P.addJunction({ ...w, type: "junction" })), C.edges.map((w) => P.addEdge(w));
}, "populateDb"), Pe = {
  parser: {
  ...
  parse: /* @__PURE__ */ dt(async (C) => {
    const P = await lr("architecture", C);
    Re.debug(P);
...
`, "getStyles"), Ir = xr, re = /* @__PURE__ */ dt((C) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${C}</g>`, "wrapIcon"), ae = {
...
}, Rr = /* @__PURE__ */ dt(async function(C, P, w, U) {
  ...
  await Promise.all(
    P.edges().map(async (i) => {
      ...
      const { x: N, y: F } = i[0].midpoint();
      let { x: A, y: G } = i[0].targetEndpoint();
      const k = L + 4;
      if (t && (Wt(r) ? g += r === "L" ? -k : k : d += r === "T" ? -k : k + 18), l && (Wt(s) ? A += s === "L" ? -k : k : G += s === "T" ? -k : k + 18), !t && w.getNode(f)?.type === "junction" && (Wt(r) ? g += r === "L" ? h : -h : d += r === "T" ? h : -h), !l && w.getNode(o)?.type === "junction" && (Wt(s) ? A += s === "L" ? h : -h : G += s === "T" ? h : -h), i[0]._private.rscratch) {
        const X = C.insert("g");
        if (X.insert("path").attr("d", `M ${g},${d} L ${N},${F} L${A},${G} `).attr("class", "edge").attr("id", `${U}-${nr(f, o, { prefix: "L" })}`), v) {
          const J = Wt(r) ? oe[r](g, a) : g - e, D = qt(r) ? oe[r](d, a) : d - e;
          X.insert("polygon").attr("points", xe[r](a)).attr("transform", `translate(${J},${D})`).attr("class", "arrow");
        }
        if (c) {
          const J = Wt(s) ? oe[s](A, a) : A - e, D = qt(s) ? oe[s](G, a) : G - e;
          X.insert("polygon").attr("points", xe[s](a)).attr("transform", `translate(${J},${D})`).attr("class", "arrow");
        }
        if (T) {
          const J = me(r, s) ? "XY" : Wt(r) ? "X" : "Y";
          let D = 0;
          J === "X" ? D = Math.abs(g - A) : J === "Y" ? D = Math.abs(d - G) / 1.5 : D = Math.abs(g - A) / 2;
          const rt = X.append("g");
          if (await Ee(
            rt,
            T,
            ...
            rt.attr("transform", "translate(" + N + ", " + F + ")");
          else if (J === "Y")
            rt.attr("transform", "translate(" + N + ", " + F + ") rotate(-90)");
          else if (J === "XY") {
            const n = pe(r, s);
            if (n && Tr(n)) {
...
}, "drawEdges"), Sr = /* @__PURE__ */ dt(async function(C, P, w, U) {
  const u = w.getConfigField("padding") * 0.75, h = w.getConfigField("fontSize"), e = w.getConfigField("iconSize") / 2;
  await Promise.all(
    P.nodes().map(async (i) => {
      const f = ie(i);
      if (f.type === "group") {
        const { h: r, w: v, x1: t, y1: o } = i.boundingBox(), s = C.append("rect");
        s.attr("id", `${U}-group-${f.id}`).attr("x", t + e).attr("y", o + e).attr("width", v).attr("height", r).attr("class", "node-bkg");
        const c = C.append("g");
        let l = t, T = o;
        if (f.icon) {
          const g = c.append("g");
        ...
        w.setElementForId(f.id, s);
      }
    })
  );
}, "drawGroups"), Fr = /* @__PURE__ */ dt(async function(C, P, w, U) {
  const L = ye();
  for (const u of w) {
    const h = P.append("g"), a = C.getConfigField("iconSize");
    if (u.title) {
      const r = h.append("g");
      await Ee(
        r,
    ...
    if (u.icon)
      ...
      const t = e.append("g").append("foreignObject").attr("width", a).attr("height", a).append("div").attr("class", "node-icon-text").attr("style", `height: ${a}px;`).append("div").html(ir(u.iconText, L)), o = parseInt(
  ...
  w.forEach((L) => {
    const u = P.append("g"), h = C.getConfigField("iconSize");
      ...
      if (f) {
        ...
        if (r) {
          ...
          Object.entries(i).forEach(([t, o]) => {
            const s = U([v[0] + o[0], v[1] + o[1]]), c = h[s];
            c && !e[s] && (a.push(s), w.push({
              [De[t]]: c,
              [De[mr(t)]]: r,
              gap: 1.5 * P.getConfigField("iconSize")
            }));
          });
        }
      }
...
function ze(C, P, w, U, L, { spatialMaps: u, groupAlignments: h }) {
  return new Promise((a) => {
    ...
    e.remove(), Xe(w, i), Ge(C, i, L), Ue(P, i, L), He(U, i);
    const f = We(L, u, h), r = Ve(u, L), v = i.layout({
      name: "fcose",
      quality: "proof",
    ...
    v.one("layoutstop", () => {
      function t(o, s, c, l) {
        ...
        g = (l - N + (d - c) * (N - A) / (d - F)) / Math.sqrt(1 + Math.pow((N - A) / (d - F), 2)), T = Math.sqrt(Math.pow(l - N, 2) + Math.pow(c - d, 2) - Math.pow(g, 2));
        const G = Math.sqrt(Math.pow(F - d, 2) + Math.pow(A - N, 2));
        T = T / G;
        let k = (F - d) * (l - N) - (A - N) * (c - d);
        switch (!0) {
          case k >= 0:
            k = 1;
            break;
      ...
      for (const o of Object.values(i.edges()))
        if (o.data?.()) {
          const { x: s, y: c } = o.source().position(), { x: l, y: T } = o.target().position();
          if (s !== l && c !== T) {
            const g = o.sourceEndpoint(), d = o.targetEndpoint(), { sourceDir: N } = Fe(o), [F, A] = qt(N) ? [g.x, d.y] : [d.x, g.y], { weights: G, distances: k } = t(g, d, F, A);
...
var Pr = /* @__PURE__ */ dt(async (C, P, w, U) => {
  const L = U.db;
  L.setDiagramId(P);
  const u = L.getServices(), h = L.getJunctions(), a = L.getGroups(), e = L.getEdges(), i = L.getDataStructures(), f = Be(P), r = f.append("g");
  r.attr("class", "architecture-edges");
  const v = f.append("g");
  v.attr("class", "architecture-services");
  const t = f.append("g");
  t.attr("class", "architecture-groups"), await Fr(L, v, u, P), br(L, v, h, P);
  const o = await ze(u, h, a, e, L, i);
  await Rr(r, o, L, P), await Sr(t, o, L, P), Ye(L, o), ke(void 0, f, L.getConfigField("padding"), L.getConfigField("useMaxWidth"));
}, "draw"), Gr = { draw: Pr }, Vr = {
  parser: Pe,
  get db() {
    return new be();
