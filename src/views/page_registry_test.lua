    ...
    test.describe("page registry", function()
        ...
        test.describe("proxy config", function()
            ...
            test.it("component page without proxy block gets defaults", function()
                ...
                test.eq(page.proxy.enabled, true)
                test.eq(page.proxy.css.fonts, true)
                test.eq(page.proxy.css.theme_config, true)
                test.eq(page.proxy.css.iframe, true)
                test.eq(page.proxy.css.prime_vue, false)
                test.eq(page.proxy.css.markdown, false)
                test.eq(page.proxy.css.custom_css, false)
                test.eq(page.proxy.css.custom_variables, false)
                test.eq(page.proxy.tailwind_config, false)
                test.eq(page.proxy.resize_observer, true)
                test.eq(page.proxy.prevent_link_clicks, true)
                test.eq(page.proxy.iconify_icons, false)
            end)
            ...
            test.it("component page with proxy block merges over defaults", function()
                ...
                test.not_nil(page.proxy)
                test.eq(page.proxy.enabled, true)
                test.eq(page.proxy.css.prime_vue, true)
                test.eq(page.proxy.css.markdown, true)
                test.eq(page.proxy.tailwind_config, true)
                test.eq(page.proxy.resize_observer, true)
                test.eq(page.proxy.prevent_link_clicks, true)
            end)
            ...
            test.it("partial proxy can override defaults to false", function()
                ...
                test.is_nil(err)
                test.eq(page.proxy.enabled, false)
                test.eq(page.proxy.css.fonts, false)
                test.eq(page.proxy.css.theme_config, true)
                test.eq(page.proxy.css.iframe, true)
            end)
